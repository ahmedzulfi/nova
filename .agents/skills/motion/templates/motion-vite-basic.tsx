...
export function FadeInBox() {
  return (
    <motion.div
      ...
      className="p-6 bg-blue-100    rounded-sm "
    >
...
export function InteractiveButton() {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="px-6 py-3 bg-blue-600 text-white    rounded-sm  font-semibold"
    >
      Hover and Click Me
    </motion.button>
  )
  ...
  return (
    <div className="relative w-full h-64 bg-gray-100    rounded-sm  overflow-hidden">
      <motion.div
        ...
        className="absolute w-16 h-16 bg-red-500    rounded-sm  cursor-grab active:cursor-grabbing flex items-center justify-center text-white font-bold"
      >
        DRAG
      </motion.div>
    </div>
...
export function ColorChangeCard() {
  return (
    <motion.div
      ...
      className="p-6 bg-gray-200 text-gray-900    rounded-sm  cursor-pointer"
    >
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className="px-6 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white    rounded-sm "
      >
