...
export function Carousel({ images }: CarouselProps) {
  ...
  return (
    <div className="relative w-full h-96 overflow-hidden bg-gray-100 dark:bg-gray-800    rounded-sm ">
      {/* Image */}
...
export function DragCarousel({ items }: DragCarouselProps) {
  ...
  return (
    <div
      ref={constraintsRef}
      className="overflow-hidden bg-gray-100 dark:bg-gray-800    rounded-sm  p-4"
    >
      <motion.div
        drag="x"
