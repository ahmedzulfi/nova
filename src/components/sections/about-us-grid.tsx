      ...
      <div className="container mx-auto px-6 max-w-[1280px]">
        {/* Top Bento Block: Yellow Main Block */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
            <div className="lg:col-span-8 bg-[#F7F56D] rounded-[32px] p-8 md:p-12 flex flex-col justify-between items-start min-h-[460px]">
            ...
            <div className="lg:col-span-4 grid grid-cols-2 gap-4 h-full">
              <div className="relative h-full min-h-[460px] lg:min-h-0 rounded-[32px] overflow-hidden">
                <Image
                  src="https://images.unsplash.com/photo-1541591419107-bb248ff6677a?q=80&w=1974&auto=format&fit=crop"
                  alt="Happy Dog"
                  fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-5 bg-[#FFF98F] rounded-[32px] p-8 md:p-12 flex flex-col justify-between">
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                ...
                <div className="flex -space-x-3">
                  {[
                    ...
                    <div key={i} className="relative w-10 h-10 rounded-full border-2 border-[#FFF98F] overflow-hidden">
                      <Image
                        src={avatar}
                  ...
                  <div className="w-10 h-10 rounded-full bg-black border-2 border-[#FFF98F] flex items-center justify-center text-white text-[12px] font-bold">
                    +
                  </div>
                </div>
              </div>
