...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#FFF2E5] flex flex-col lg:block">
      
      {/* Background / Left Media - Absolute on desktop, relative on mobile */}
      <div className="relative lg:absolute lg:inset-0 w-full h-[300px] sm:h-[450px] lg:h-[822px] z-0 overflow-hidden border-b border-black/5 lg:border-none">
        <video
          autoPlay
          muted
          loop
        ...
        {/* Floating Badges inside the media container */}
        ...
        <div className="absolute bottom-8 left-8 right-8 max-w-md z-20 hidden sm:block">
      ...
      <div className="relative z-10 w-full lg:h-[822px] flex items-center">
        <div className="container mx-auto px-6 max-w-[1280px] flex justify-end w-full py-8 lg:py-0">
          <div className="w-full lg:max-w-[437px] bg-[#FBC84F]/90 backdrop-blur-md rounded-[33px] p-8 md:p-10 flex flex-col gap-6 shadow-xl border border-white/20 relative overflow-hidden">
            {/* Headline */}
