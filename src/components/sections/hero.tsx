  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-[1330px] mx-auto px-6 md:px-12 pb-24 md:pb-36 flex flex-col md:flex-row items-start md:items-end justify-between gap-10 md:gap-6 will-change-transform"
      >
        ...
        <div className="flex flex-col items-start gap-4 max-w-[640px]">
          ...
          <div className="flex flex-col gap-2.5">
            <div className="flex items-center gap-3 text-white/90">
              <Calendar className="w-5 h-5 text-[#FBC84F] shrink-0" />
              <span className="text-[13px] md:text-[15px] font-mono uppercase tracking-[0.2em]">
                {dateStr}
              </span>
            </div>
            <div className="flex items-center gap-3 text-white/90">
              <MapPin className="w-5 h-5 text-[#FBC84F] shrink-0" />
              <span className="text-[13px] md:text-[15px] font-mono uppercase tracking-[0.2em]">
                {locationStr}
              </span>
            </div>
