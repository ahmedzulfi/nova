    ...
    <section className="relative w-full overflow-hidden bg-white pt-[120px] pb-[80px] md:pt-[160px] md:pb-[120px]">
      <div className="container mx-auto px-6 max-w-[1280px]">
        <div className="flex flex-col items-center text-center">
            ...
            {/* Badge */}
            <div 
              className="group mb-8 inline-flex items-center gap-2 px-4 py-2 bg-secondary rounded-full transition-all hover:bg-secondary/90"
            >
            ...
            {/* Headline */}
            <h1 className="mb-6 text-[48px] md:text-[84px] font-bold leading-[1.1] tracking-[-0.035em] text-black font-display max-w-[900px]">
          ...
          {/* Video Container */}
          <div className="relative w-full aspect-video rounded-[32px] md:rounded-[48px] overflow-hidden shadow-2xl">
            <video 
              autoPlay 
              muted 
              loop 
