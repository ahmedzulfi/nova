        ...
        <section className="bg-white py-16 md:py-24">
            <div className="container mx-auto px-6 max-w-[1280px]">
                ...
                <div className="mb-12 md:mb-16 max-w-[800px]">
                    <span className="inline-block bg-[#F3F3F3] text-black text-[12px] font-semibold px-4 py-1.5 rounded-sm uppercase tracking-wider mb-6">
                        Explore Our Zones
                    </span>
                    <h2 className="text-[28px] md:text-[56px] leading-[1.1] font-bold text-black tracking-tight font-display">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="bg-primary rounded-sm p-8 md:p-12 flex flex-col justify-between min-h-[480px] overflow-hidden relative group shadow-sm">
                            <div className="relative z-10">
                                <div className="w-14 h-14 bg-white rounded-sm flex items-center justify-center mb-8 shadow-sm">
                                    <Dog className="text-primary w-8 h-8" />
                                </div>
                                <h3 className="text-white text-[24px] md:text-[42px] font-bold mb-6 font-display">Dog Zone</h3>
                            ...
                            <div className="relative z-10">
                                <a
                                    href="/registration"
                                    className="inline-flex items-center justify-between gap-4 bg-black text-white px-8 py-4 rounded-sm font-bold uppercase tracking-widest text-[12px] transition-transform hover:scale-105 active:scale-95 group/btn"
                                >
                        ...
                        <div className="relative h-[240px] rounded-sm overflow-hidden shadow-sm">
                            <Image
                    ...
                    <div className="flex flex-col-reverse lg:flex-col gap-6">
                        ...
                        <div className="bg-accent rounded-sm p-8 md:p-12 flex flex-col justify-between min-h-[480px] overflow-hidden relative group shadow-sm">
                            <div className="relative z-10">
                                <div className="w-14 h-14 bg-white rounded-sm flex items-center justify-center mb-8 shadow-sm">
                                    <Cat className="text-accent w-8 h-8" />
                                </div>
                                <h3 className="text-white text-[24px] md:text-[42px] font-bold mb-6 font-display">Cat Zone</h3>
                                <ul className="space-y-3 mb-10">
