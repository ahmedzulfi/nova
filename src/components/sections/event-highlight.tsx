...
<h2 className="text-[40px] md:text-[56px] font-semibold font-display leading-[1.1] text-[#111111] mb-6 tracking-tight">
Dog Zone & Cat Zone
</h2>
</div>
...
<a
href="/registration"
className="group inline-flex items-center justify-between w-full md:w-auto md:min-w-[200px] bg-[#F7F58E] hover:bg-[#ecea7d] text-[#111111] font-semibold px-8 py-4 rounded-full transition-all duration-300"
>
