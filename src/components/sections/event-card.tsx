          ...
          <div className="container relative z-10 px-6 md:px-12">
            <div className="bg-white max-w-[480px] rounded-[24px] p-8 md:p-12 shadow-sm flex flex-col gap-6">
              ...
              <div className="pt-2">
                <a
                  href="/registration"
                  className="inline-flex items-center justify-between gap-6 px-8 py-4 rounded-full bg-[#F7F56D] text-[#000000] font-semibold text-[16px] transition-transform hover:scale-105 active:scale-95 group font-body min-w-[200px]"
                >
