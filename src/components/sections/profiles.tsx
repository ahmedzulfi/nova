    ...
    <section className="py-[120px] bg-white overflow-hidden">
      <div className="container mx-auto px-6 max-w-[1280px]">
        ...
        <div className="flex justify-center mt-12">
          <a
            href="/registration"
            className="group flex items-center justify-between bg-primary hover:bg-primary/90 text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 active:scale-95"
            style={{ fontSize: '16px' }}
          >
